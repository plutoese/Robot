...
class Report:
    ...
    # 添加matplotlib的图形
    def addMatplot(self,plt,filepath='d:/down/',caption=None):
...
if __name__ == '__main__':
    ...
    report.addFigure('D:/down/europe.jpg')
    report.addList(['你们','我们'])
    tdata = [[1,2,3,4],[5,6,7,8]]
    report.addTable([['变量', '第一产业占GDP的比重_全市', '第一产业占GDP的比重_市辖区','我错了'],[1,2,3,4],[5,6,7,8]],3,4)
    ...
    report.flush()
    report.generate_pdf('d:/down/first_report')
