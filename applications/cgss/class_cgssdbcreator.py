...
# ------------------------------------------------------------------
# class_cgssdbcreator文件
# @class: Cgssdbcreator类
# @introduction: Cgssdbcreator类用来读写cgss.dta（stata格式）的数据文件
...
if __name__ == '__main__':
    filename = "E:/Data/micro/cgss2005_new.dta"
    st = CgssStataSheet(filename, year=2005)
    print(st.stata_file)
